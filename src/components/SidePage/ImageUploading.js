...
const ImageUploading = ({handleImg , img}) => {
  return (
    <>
        <ImgUpload
            value={img}
        ...
        >
            {({
                ...
                errors
                    ...
                    <>
                            <button type='button' className='btn customized' onClick={onImageUpload} title='Upload Image'><ImageIcon/></button>
                            {
                                    ...
                                    <>
                                        {imageList.map((image , index) => (
                                                <div key={index} className='w-100'>
                                                        <img src={image['data_url']} alt='no img loaded' className='setting-background-img mt-2' draggable={false}/>
